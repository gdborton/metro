...
const DEFAULT = ({
  ...
  getAsyncRequireModulePath: () => 'metro/build/lib/bundle-modules/asyncRequire',
  getAssetExts: () => [],
  ...
  getSourceExts: () => [],
  getTransformModulePath: () => 'metro/build/defaultTransformer',
  ...
  getWorkerPath: () => 'metro/build/DeltaBundler/Worker',
